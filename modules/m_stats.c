...
static void stats_proxy(struct Client *);
static void stats_ipbr(struct Client *);
static void stats_spamsg(struct Client *);
static void stats_vlink(struct Client *);
 ...
 */
static void
stats_proxy(struct Client *source_p)
{
    PROXYLIST(source_p);
}
 ...
 */
static void
stats_ipbr(struct Client *source_p)
{
    IPBRLIST(source_p);
}
 ...
 */
static void
stats_vlink(struct Client *source_p)
{
    VLINKLIST(source_p);
}
 ...
 */
static void
stats_spamsg(struct Client *source_p)
{
    SPAMSGLIST(source_p);
}
