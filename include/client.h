...
#define FLAGS_NORMALEX      0x0000000200000000ULL   /* Usuando no +q */

/* umodes, settable flags */
#define UMODE_SERVNOTICE   0x00000001   /* server notices such as kill              */
#define UMODE_REJ          0x00000002   /* Bot Rejections                           */
#define UMODE_SKILL        0x00000004   /* Server Killed                            */
#define UMODE_FULL         0x00000008   /* Full messages                            */
#define UMODE_SPY          0x00000010   /* see STATS / LINKS                        */
#define UMODE_DEBUG        0x00000020   /* 'debugging' info                         */
#define UMODE_NCHANGE      0x00000040   /* Nick change notice                       */
#define UMODE_WALLOP       0x00000080   /* send wallops to them                     */
#define UMODE_OPERWALL     0x00000100   /* Operwalls                                */
#define UMODE_INVISIBLE    0x00000200   /* makes user invisible                     */
#define UMODE_BOTS         0x00000400   /* shows bots                               */
#define UMODE_UNAUTH       0x00000800   /* show unauth connects here                */
#define UMODE_LOCOPS       0x00001000   /* show locops                              */
#define UMODE_DEAF         0x00002000   /* don't receive channel messages           */
#define UMODE_CLOAK        0x00004000   /* user has their hostname cloaked          */
#define UMODE_SSL          0x00008000   /* client is connected via SSL              */
#define UMODE_REGNICK      0x00010000   /* client has identified for their nick     */
#define UMODE_REGONLY      0x00020000   /* only accept privmsgs from +r users       */
#define UMODE_CCONN        0x00040000   /* Client Connections                       */
#define UMODE_HIDECHANNELS 0x00080000   /* suppress output of channel list on WHOIS */
#define UMODE_GRINGO       0x00100000   // eh um gringo
#define UMODE_ZOMBIE       0x00200000   // eh zombie'
#define UMODE_OPER         0x00400000   /* Operator                                 */
#define UMODE_ADMIN        0x00800000   /* Admin on server                          */
#define UMODE_NETADMIN     0x01000000   /* Network Administrator                    */
#define UMODE_SADMIN       0x02000000
#define UMODE_SOPER        0x04000000
#define UMODE_HELPER       0x08000000
#define UMODE_VADMIN       0x10000000
#define UMODE_VOPER        0x20000000
...
#define SEND_UMODES  (UMODE_INVISIBLE | UMODE_OPER | UMODE_WALLOP | UMODE_SPY | \
                      ...
                      UMODE_GRINGO | UMODE_ZOMBIE | UMODE_HELPER | \
                      UMODE_SADMIN | UMODE_SOPER | UMODE_CCONN | UMODE_VADMIN | UMODE_VOPER )
...
#define IsConn(x)               ((x)->umodes & UMODE_CCONN)
...
#define SetSOper(x)          ((x)->umodes |= UMODE_SOPER)
#define ClearSOper(x)        ((x)->umodes &= ~UMODE_SOPER)
#define IsSOper(x)           ((x)->umodes & UMODE_SOPER)
...
#define SetGringo(x)          ((x)->umodes |= UMODE_GRINGO)
#define ClearGringo(x)        ((x)->umodes &= ~UMODE_GRINGO)
#define IsGringo(x)           ((x)->umodes & UMODE_GRINGO)

#define SetVAdmin(x)          ((x)->umodes |= UMODE_VADMIN)
#define ClearVAdmin(x)        ((x)->umodes &= ~UMODE_VADMIN)
#define IsVAdmin(x)           ((x)->umodes & UMODE_VADMIN)

#define SetVOper(x)          ((x)->umodes |= UMODE_VOPER)
#define ClearVOperp(x)        ((x)->umodes &= ~UMODE_VOPER)
#define IsVOper(x)           ((x)->umodes & UMODE_VOPER)

#define IsAnVOper(x)             ((x)->umodes & (UMODE_VADMIN|UMODE_VOPER))
