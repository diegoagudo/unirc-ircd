...
#define CAP_PXY     0x00100000
#define CAP_ZOMBIE  0x00200000
#define CAP_SPM     0x00400000
#define CAP_SVSINFO 0x00800000
#define CAP_FLOODEX 0x01000000
#define CAP_IPBR    0x02000000
#define CAP_VLINK   0x04000000
