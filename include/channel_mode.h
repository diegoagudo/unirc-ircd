...
#define MODE_NOCTRL     0x00080
#define MODE_OPERONLY   0x00100
#define MODE_MODREG     0x00200
#define MODE_NOSPAM     0x00400
#define MODE_BWSAVER    0x00800
#define MODE_NONOTICES  0x01000
