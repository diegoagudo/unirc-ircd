...
#define MENAME(x) (IsServer(x)?me.name:(MyClient(x)?((x)->vlink_nome?(x)->vlink_nome:me.name):me.name))
#define MENAMEmy(x) (MyClient(x)?(x)->vlink_nome?(x)->vlink_nome:me.name:me.name)

//#define MENAME(x) (IsServer(x)?me.name:(MyClient(x)?((x)->user->vs?(x)->user->vs:"irc.brasnet.org"):me.name))
//#define MENAMEmy(x) ((x)->user?(x)->user->vs?(x)->user->vs:"irc.brasnet.org":"irc.brasnet.org")
