...
#define NETWORK_NAME_DEFAULT "UnIRC"	                    /* default for network_name */
#define NETWORK_DESC_DEFAULT "UnIRC Network"	/* default for network_desc */
...
#define SERVICES_NAME_DEFAULT "services.unirc.net"	/* default for services_name */
